export type TabView = 'activity' | 'adaptiveWorkflows' | 'agent-comparison' | 'agentDashboard' | 'agentcore' | 'agentdashboard' | 'agentflow' | 'agentmesh' | 'agentorchestrator' | 'agentself' | 'analyticsEngine' | 'anomalyDetector' | 'scenarioSimulator' | 'explanationSynthesizer' | 'knowledgeDistiller' | 'attentionAllocator' | 'ethicalDeliberation' | 'conceptFormation' | 'analogyEngine' | 'curiosityEngine' | 'mentalSimulation' | 'narrativeEngine' | 'cognitiveMapping' | 'biasDetector' | 'cognitiveAffordance' | 'cognitiveScaffolding' | 'affectiveEngine' | 'cognitiveStyleTransfer' | 'cognitivePrime' | 'cognitivePhaseTransition' | 'cognitiveGravity' | 'cognitiveResonance' | 'cognitiveWorkload' | 'cognitiveEntropy' | 'cognitiveHorizon' | 'cognitiveMomentum' | 'cognitiveFriction' | 'cognitiveTension' | 'cognitiveDepth' | 'cognitiveCoherence' | 'cognitiveRhythm' | 'cognitiveDiffusion' | 'cognitiveSymbology' | 'cognitiveCatalyst' | 'cognitiveRefraction' | 'cognitiveOsmosis' | 'cognitiveBuoyancy' | 'cognitiveImmunity' | 'cognitiveViscosity' | 'cognitivePolarization' | 'cognitiveInertia' | 'cognitiveTurbulence' | 'cognitiveCadence' | 'cognitiveDrift' | 'cognitiveResilience' | 'cognitiveLattice' | 'cognitiveSingularity' | 'approval' | 'automation' | 'autonomyFramework' | 'autopilot' | 'board' | 'browseragent' | 'capability' | 'capabilityMesh' | 'causalEngine' | 'temporalEngine' | 'chainOfThought' | 'chat' | 'codeInterpreter' | 'codeReview' | 'collaboration' | 'collaborativeIntelligence' | 'collabspace' | 'commandCenter' | 'compounding' | 'contextCompressor' | 'contextWeaver' | 'contextengine' | 'contextmanager' | 'conversationMemory' | 'conversationsearch' | 'costAnalytics' | 'costs' | 'crossConnector' | 'daemon' | 'dashboard' | 'deployment' | 'dream' | 'dreammode' | 'dynamicAdaptation' | 'emergentBehavior' | 'eventpipeline' | 'events' | 'evolution' | 'evolutionLoop' | 'evolvingskills' | 'executionCompiler' | 'experience' | 'experiments' | 'federatedKnowledge' | 'feedbackOrchestrator' | 'fleet' | 'forge' | 'gateway' | 'goalDecomposer' | 'governance' | 'guard' | 'identity' | 'identitycore' | 'imhub' | 'integrationhub' | 'intelligence' | 'intelligenceHub' | 'intent' | 'intentResolution' | 'issueBoard' | 'kanban' | 'kgraph' | 'knowledge' | 'knowledgeBase' | 'knowledgeFabric' | 'knowledgeGraph' | 'knowledgeGraphViz' | 'knowledgenetwork' | 'learning' | 'learningloop' | 'marketplace' | 'mcp' | 'mcpServer' | 'mcpconnector' | 'mcptools' | 'memory' | 'memoryConsolidator' | 'memorysync' | 'metacognition' | 'modelConductor' | 'modelOrchestrator' | 'modelorch' | 'modelproxy' | 'nexus' | 'overview' | 'performanceAutotuner' | 'persona' | 'phub' | 'pipeline' | 'planexec' | 'plans' | 'platformConsole' | 'platformHub' | 'platformResilience' | 'platformcore' | 'plugins' | 'presenceEngine' | 'proactive' | 'proactiveDiscovery' | 'proactiveEngine' | 'productcomposer' | 'profile' | 'protocol' | 'pulse' | 'quotaManager' | 'reasoning' | 'reflection' | 'runtime' | 'runtimeCoordinator' | 'runtimeHub' | 'runtimeScheduler' | 'runtimeStore' | 'runtimebackend' | 'runtimecoordinator' | 'runtimemonitor' | 'runtimepanel' | 'sandbox' | 'scheduler' | 'selfReflection' | 'sentienceCore' | 'sessionCommander' | 'skillExplorer' | 'skillcompiler' | 'skillfabric' | 'skillmanager' | 'skills' | 'smartrouter' | 'squads' | 'streaming' | 'streamingHub' | 'studio' | 'subAgents' | 'subagentmesh' | 'subagents' | 'swarm' | 'swarmConsole' | 'synthesis' | 'taskqueue' | 'tasks' | 'teamArchitect' | 'telemetry' | 'terminalagent' | 'toolExecutor' | 'toolNetwork' | 'toolcomposer' | 'toolexec' | 'tracingPipeline' | 'tools' | 'trajectory' | 'uncertaintyQuantifier' | 'unifiedSystem' | 'unifiedagent' | 'unifiedbrain' | 'unifiedconsole' | 'usermodel' | 'verificationPipeline' | 'whiteboxMemory' | 'whitememory' | 'workflow' | 'workspace' | 'workspaceNexus' | 'workspaces' | 'personalMemory' | 'voiceInterface' | 'documentIntelligence' | 'notificationHub' | 'promptStudio' | 'terminalInterface' | 'reasoningNetwork' | 'synthesisEngine' | 'researchEngine' | 'learningLoop' | 'memoryGraph' | 'understandingEngine' | 'hypothesisEngine' | 'negotiation' | 'aiTwin' | 'codeSynthesis' | 'workflowComposer' | 'skillForge' | 'policyGateway' | 'dreamConsolidator' | 'crossReview' | 'costOptimizer' | 'lifecycleHooks' | 'sessionFork' | 'alignmentEngine' | 'contextProvider' | 'interruptibleExec' | 'actionSpace' | 'goalManager' | 'dialogueManager' | 'benchmarkEngine' | 'beliefEngine';
